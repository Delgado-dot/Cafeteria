...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunSQL(
            ...
            """,
            reverse_sql="DROP VIEW IF EXISTS vw_productos_disponibles;",
        ),
        migrations.RunSQL(
            sql="""
            ...
            """,
            reverse_sql="DROP VIEW IF EXISTS vw_stock_bajo;",
        ),
        migrations.RunSQL(
            sql="""
            ...
            """,
            reverse_sql="DROP VIEW IF EXISTS vw_pedidos_activos;",
        ),
        migrations.RunSQL(
            sql="""
            ...
            """,
            reverse_sql="DROP VIEW IF EXISTS vw_ventas_diarias;",
        ),
        migrations.RunSQL(
            sql="""
            ...
            """,
            reverse_sql="DROP VIEW IF EXISTS vw_resumen_pagos;",
        ),
        migrations.RunSQL(
            sql="""
            ...
            """,
            reverse_sql="DROP VIEW IF EXISTS vw_detalle_pedidos;",
        ),
        migrations.RunSQL(
            sql="""
            ...
            """,
            reverse_sql="DROP VIEW IF EXISTS vw_movimientos_inventario;",
        ),
        migrations.RunSQL(
            sql="""
            ...
            """,
            reverse_sql="DROP VIEW IF EXISTS vw_productos_proveedores;",
        ),
        migrations.RunSQL(
            sql="""
                ...
                LEFT JOIN usuarios u ON u.id = pe.user_id;
            """,
            reverse_sql="DROP VIEW IF EXISTS vw_delivery_pedidos;",
        ),
        migrations.RunSQL(
            sql="""
            ...
            """,
            reverse_sql="DROP VIEW IF EXISTS vw_historial_estados_pedidos;",
        ),
    ]
