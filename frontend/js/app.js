  ...
  (async () => {
    ...
    app.innerHTML = `
      <div class="menu-page">
        <div class="menu-lead">
          <div>
            <div class="ml-title title-format">Nuestro <span class="title-format-color-2">menú</span></div>
            <div class="ml-sub"><span class="ml-sub-white">Todo rico y recién</span> <span class="ml-sub-teal">preparado en la cafetería.</span></div>
          </div>
...
function userProductPage(el) {
  ...
  (async () => {
    ...
    app.innerHTML = `
      <button class="btn btn-ghost btn-sm back-to-menu-btn" style="margin-bottom:16px" onclick="setRoute('menu')"><i class="bx bx-arrow-back"></i> Volver al menú</button>
